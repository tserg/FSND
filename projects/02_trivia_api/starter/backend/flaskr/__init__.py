        ...
        try:
            ...
            if formatted_results == []:
                ...
                return jsonify({
                    ...
                    'current_category': [(question['category']) for
                                         question in formatted_results]
                })
  ...
  '''
    ...
    def play_quiz():
        ...
        try:
            ...
            previous_questions = [int(question_id)
            ...
            if quiz_category == 0:
                ...
                all_category_questions = Question.query.filter(
                    Question.category == quiz_category).all()

            all_category_questions_formatted = [
                category_question.format() for category_question in all_category_questions]
